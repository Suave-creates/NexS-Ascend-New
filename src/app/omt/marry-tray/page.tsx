            ...
            <div className="result-grid">
              <section className="child-panel">
                ...
                <div className="child-id-row">
                  <div className="id-tile"><small>Child tray</small><b>{lookup.childTrayId}</b></div>
                  {lookup.trayLensCode && (
                    <div className="id-tile lens-badge"><small>Lens in tray</small><b className="lens-red">{lookup.trayLensCode}</b></div>
                  )}
                </div>
                {isNddOrder(lookup.priority, lookup.orderMode) && <div className="ndd-ribbon">NDD Priority Order</div>}
...
.result-grid{display:grid;grid-template-columns:240px 1fr;grid-template-areas:"child pick" "stack stack";gap:11px}.child-panel,.pick-panel,.stack-panel{border:1px solid var(--line);border-radius:14px;background:var(--bg0)}.child-panel{grid-area:child;padding:14px}.section-title{display:flex;align-items:center;justify-content:space-between;color:var(--muted);font-size:8px;font-weight:800;letter-spacing:1.1px;text-transform:uppercase}.section-title small{font-size:8px;color:var(--muted)}.child-id-row{display:flex;align-items:stretch;gap:10px;margin:12px 0}.id-tile{flex:1;min-width:0;padding:9px 12px;border:1px solid var(--line);border-radius:11px;background:var(--bg2);display:flex;flex-direction:column;justify-content:center}.id-tile small{color:var(--muted);font-size:8px;text-transform:uppercase}.id-tile b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--text);font-size:20px;letter-spacing:.5px}.lens-badge{flex:none;min-width:70px;text-align:center;border-color:rgba(178,34,34,.4);background:rgba(178,34,34,.08)}.lens-badge b.lens-red{color:#b22222}.visibility-metrics{display:grid;grid-template-columns:1fr 1fr;gap:7px}.visibility-metrics>div{padding:9px;border:1px solid var(--line);border-radius:9px;background:var(--bg2);display:flex;flex-direction:column}.visibility-metrics small{color:var(--muted);font-size:7.5px;font-weight:800;text-transform:uppercase}.visibility-metrics b{font-size:14px}.visibility-metrics b.jit{color:var(--purple)}.visibility-metrics b.regular{color:var(--blue)}.visibility-metrics b.danger{color:var(--red)}
.ndd-ribbon{margin:-2px 0 8px;padding:7px;border:1px solid rgba(124,58,237,.45);border-radius:8px;background:rgba(76,29,149,.2);color:#c4b5fd;font-size:9px;font-weight:900;letter-spacing:1px;text-align:center;text-transform:uppercase}
...
@media(max-width:700px){.result-grid{grid-template-columns:1fr;grid-template-areas:"child" "pick" "stack"}.child-panel{display:grid;grid-template-columns:1fr 1fr;gap:10px}.child-panel .section-title{grid-column:1/-1}.child-id-row{margin:0}.pick-panel{min-height:150px}}
...
@media(prefers-reduced-motion:reduce){.ndd-ribbon{animation:none}}
`;
