// src/app/packing-dispatch/kitne-parcel-the/page.tsx
'use client';
...
export default function KitneParcelThePage() {
  ...
  async function run() {
    ...
    setBusy(true);
    try {
      const res = await apiFetch('/api/packing-dispatch/kitne-parcel-the', {
        method: 'POST',
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <PageHeader
        title={
          <>
            Kitne <span className="text-gold-600">Parcel</span> The?
          </>
        }
      ...
      <Card>
        <CardBody className="space-y-4">
          ...
          {!error && !stamp && (
            <p className="text-sm italic text-gray-500">CSV downloads automatically.</p>
          )}
        </CardBody>
      </Card>
    </div>
