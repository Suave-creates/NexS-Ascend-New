    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-full mx-auto">
        ...
        <Card className="overflow-hidden">
          <Table>
            ...
            <TBody>
              {loading ? (
                <TR>
                  <TD colSpan={15} className="px-4 py-8 text-center text-gray-900">
                    Loading...
                  </TD>
                </TR>
              ) : deviations.length === 0 ? (
                ...
                deviations.map((deviation) => (
                  <TR key={deviation.id}>
                    <TD className="text-gray-900">{deviation.month}</TD>
                    <TD className="text-gray-900">{new Date(deviation.date).toLocaleDateString()}</TD>
                    <TD className="text-gray-900">{deviation.timeOfRound}</TD>
                    <TD className="text-gray-900">{deviation.location}</TD>
                    <TD className="text-gray-900">{deviation.responsibleDepartment}</TD>
                    <TD className="text-gray-900">{deviation.remarks}</TD>
                    <TD className="max-w-xs truncate text-gray-900">{deviation.observations}</TD>
                    ...
                    <TD className="max-w-xs truncate text-gray-900">{deviation.controlMeasures}</TD>
                    <TD className="text-gray-900">
                    ...
                    <TD className="text-gray-900">{deviation.pendingDays}</TD>
                    <TD>
                      <Badge
                        tone={
                    ...
                    <TD className="max-w-xs truncate text-gray-900">{deviation.remarksByDepartment || 'N/A'}</TD>
                    <TD>
        ...
        <Modal open={showLoginModal} onClose={() => setShowLoginModal(false)} size="sm">
          <h2 className="text-xl font-bold mb-4 text-brand-700">EHS Officer Login</h2>
          <form onSubmit={handleLogin}>
            <Field label="Employee Code" className="mb-4">
              <Input
                type="text"
        ...
        >
          <h2 className="text-xl font-bold mb-4 text-brand-700">Create New Deviation</h2>
        ...
        >
          {editingDeviation && (
            <>
              <h2 className="text-xl font-bold mb-4 text-brand-700">
